...
public class AdapterRVFragmentVizhe extends RecyclerView.Adapter<AdapterRVFragmentVizhe.ViewHolder> {

    ArrayList<Model_recycler> stringList2;

    public AdapterRVFragmentVizhe (ArrayList<Model_recycler> stringList){
    ...
    @NonNull
    @Override
    public AdapterRVFragmentVizhe.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterRVFragmentVizhe.ViewHolder holder, int position) {
